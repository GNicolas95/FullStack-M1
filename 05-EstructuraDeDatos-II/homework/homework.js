...
Implementar la clase LinkedList, definiendo los siguientes métodos:
  ...
  - remove: elimina el último nodo de la lista y retorna su valor (tener en cuenta
...
Nuetra tabla hash, internamente, consta de un arreglo de buckets (slots, contenedores, o 
casilleros; es decir, posiciones posibles para almacenar la información), donde 
...
La clase debe tener los siguientes métodos:
  ...
  cantidad de buckets; de esta manera determina la posición de la tabla en la que
...
schequear, con hasKey, si ya hay algo en la tabla con el nombre 'instructora'; luego, 
