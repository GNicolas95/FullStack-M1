...
function cacheFunction(cb) {
  ...
  return function (argument) {
    if (objeto.hasOwnProperty(argument)) {
      return (objeto[argument])
    }
    objeto[argument] = cb(argument) 
    return (objeto[argument]); 
  }
}
...
let textoGuiones = crearCadena.bind("ocupado", "-", "-");
let textoUnderscore = crearCadena.bind("rouse", "_", "_");
